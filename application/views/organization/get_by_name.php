...
<head>
	...
	<title>Get Organization by Name</title>
	<style>
		* {
			margin: 0;
			padding: 0;
...
<body>
	<div class="container">
		<header>
			<h1>📝 Get Organization by Name</h1>
		</header>
		...
		<form action="/index.php/organization_form/get_by_name" method="POST">
		...
		<div class="form-group">
			...
			<div class="help-text">Masukkan nama organisasi yang ingin dicari</div>
		</div>
