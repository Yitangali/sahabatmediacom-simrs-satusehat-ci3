...
<head>
	...
	<title>Get Location by Name</title>
	<style>
		* {
			margin: 0;
			padding: 0;
...
<body>
	<div class="container">
		...
		<main>
			...
			<form action="/index.php/location_form/get_by_name" method="POST">
			...
			<div class="form-group">
				...
				<div class="help-text">Masukkan nama lokasi yang ingin dicari</div>
			</div>
