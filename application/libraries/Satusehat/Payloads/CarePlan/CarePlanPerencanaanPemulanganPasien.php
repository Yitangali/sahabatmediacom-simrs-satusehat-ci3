...
class CarePlanPerencanaanPemulanganPasien extends SatusehatPayload
{
    protected $CI;
    //protected $config;
    ...
    public function __construct()
    {
        ...
        $this->templatePath = APPPATH . 'libraries/Satusehat/Payloads/CarePlan/CarePlanPerencanaanPemulanganPasien.json';
