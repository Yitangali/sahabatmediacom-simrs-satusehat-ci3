...
class DiagnosticReportKreatininCreateDay2 extends SatusehatPayload
{
    protected $CI;
    //protected $config;
    ...
    public function __construct()
    {
        ...
        $this->templatePath = APPPATH . 'libraries/Satusehat/Payloads/DiagnosticReport/DiagnosticReportKreatininCreateDay2.json';
