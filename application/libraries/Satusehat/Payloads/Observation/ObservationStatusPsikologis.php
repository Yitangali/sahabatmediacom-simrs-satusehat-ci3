...
class ObservationStatusPsikologis extends SatusehatPayload
{
    protected $CI;
    //protected $config;
    ...
    public function __construct()
    {
        ...
        $this->templatePath = APPPATH . 'libraries/Satusehat/Payloads/Observation/ObservationStatusPsikologis.json';
