...
class ObservationEkokardiografi extends SatusehatPayload
{
    protected $CI;
    //protected $config;
    ...
    public function __construct()
    {
        ...
        $this->templatePath = APPPATH . 'libraries/Satusehat/Payloads/Observation/ObservationEkokardiografi.json';
    ...
    public function build(array $data): array
    {
        ...
        $variables = [
                'SR_Eko'                => $data['SR_Eko'],
                'Procedure_Eko'         => $data['Procedure_Eko'],
