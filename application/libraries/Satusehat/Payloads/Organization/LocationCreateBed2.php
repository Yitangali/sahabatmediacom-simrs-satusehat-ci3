...
class LocationCreateBed2 extends SatusehatPayload
{
    protected $CI;
    //protected $config;
    ...
    public function __construct()
    {
        ...
        $this->templatePath = APPPATH . 'libraries/Satusehat/Payloads/Organization/locationCreateBed2.json';
    ...
    public function build(array $data): array
    {
        ...
        $variables = [
            ...
            "Location_Ruang210_id"          => $data['Location_Ruang210_id']
        ];
