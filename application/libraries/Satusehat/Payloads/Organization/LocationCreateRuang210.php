...
class LocationCreateRuang210 extends SatusehatPayload
{
    protected $CI;
    //protected $config;
    ...
    public function __construct()
    {
        ...
        $this->templatePath = APPPATH . 'libraries/Satusehat/Payloads/Organization/locationCreateRuang210.json';
    ...
    public function build(array $data): array
    {
        ...
        $variables = [
            ...
            "Location_BangsalKelas1_id"     => $data['Location_BangsalKelas1_id']
        ];
