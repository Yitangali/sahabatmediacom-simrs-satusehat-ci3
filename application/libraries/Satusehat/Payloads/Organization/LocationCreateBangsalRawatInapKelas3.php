...
class LocationCreateBangsalRawatInapKelas3 extends SatusehatPayload
{
    protected $CI;
    //protected $config;
    ...
    public function __construct()
    {
        ...
        $this->templatePath = APPPATH . 'libraries/Satusehat/Payloads/Organization/locationCreateBangsalRawatInapKelas3.json';
