...
class LocationCreateBed4 extends SatusehatPayload
{
    protected $CI;
    //protected $config;
    ...
    public function __construct()
    {
        ...
        $this->templatePath = APPPATH . 'libraries/Satusehat/Payloads/Organization/locationCreateBed4.json';
    ...
    public function build(array $data): array
    {
        ...
        $variables = [
            ...
            "Location_Ruang206_id"          => $data['Location_Ruang206_id']
        ];
