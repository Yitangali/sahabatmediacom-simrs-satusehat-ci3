...
class LocationCreateRuang208 extends SatusehatPayload
{
    protected $CI;
    //protected $config;
    ...
    public function __construct()
    {
        ...
        $this->templatePath = APPPATH . 'libraries/Satusehat/Payloads/Organization/locationCreateRuang208.json';
    ...
    public function build(array $data): array
    {
        ...
        $variables = [
            ...
            "Location_BangsalKelas2_id"     => $data['Location_BangsalKelas2_id']
        ];
