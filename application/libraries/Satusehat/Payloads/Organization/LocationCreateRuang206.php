...
class LocationCreateRuang206 extends SatusehatPayload
{
    protected $CI;
    //protected $config;
    ...
    public function __construct()
    {
        ...
        $this->templatePath = APPPATH . 'libraries/Satusehat/Payloads/Organization/locationCreateRuang206.json';
    ...
    public function build(array $data): array
    {
        ...
        $variables = [
            ...
            "Location_BangsalKelas3_id"     => $data['Location_BangsalKelas3_id']
        ];
