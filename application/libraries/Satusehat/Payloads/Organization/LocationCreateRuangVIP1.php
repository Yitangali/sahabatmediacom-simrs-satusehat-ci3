...
class LocationCreateRuangVIP1 extends SatusehatPayload
{
    protected $CI;
    //protected $config;
    ...
    public function __construct()
    {
        ...
        $this->templatePath = APPPATH . 'libraries/Satusehat/Payloads/Organization/locationCreateRuangVIP1.json';
