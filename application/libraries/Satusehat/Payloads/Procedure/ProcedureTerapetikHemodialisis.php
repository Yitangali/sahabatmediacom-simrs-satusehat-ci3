...
class ProcedureTerapetikHemodialisis extends SatusehatPayload
{
    protected $CI;
    //protected $config;
    ...
    public function __construct()
    {
        ...
        $this->templatePath = APPPATH . 'libraries/Satusehat/Payloads/Procedure/ProcedureTerapetikHemodialisis.json';
    ...
    public function build(array $data): array
    {
        ...
        $variables = [
                'SR_Hemodialisis'       => $data['SR_Hemodialisis'],
