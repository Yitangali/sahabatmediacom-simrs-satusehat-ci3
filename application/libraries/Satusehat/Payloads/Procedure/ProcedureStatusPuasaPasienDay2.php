...
class ProcedureStatusPuasaPasienDay2 extends SatusehatPayload
{
    protected $CI;
    //protected $config;
    ...
    public function __construct()
    {
        ...
        $this->templatePath = APPPATH . 'libraries/Satusehat/Payloads/Procedure/ProcedureStatusPuasaPasienDay2.json';
