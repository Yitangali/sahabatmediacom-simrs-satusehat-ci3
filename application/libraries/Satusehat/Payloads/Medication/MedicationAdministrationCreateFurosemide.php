...
class MedicationAdministrationCreateFurosemide extends SatusehatPayload
{
    protected $CI;
    //protected $config;
    ...
    public function __construct()
    {
        ...
        $this->templatePath = APPPATH . 'libraries/Satusehat/Payloads/Medication/MedicationAdministrationCreateFurosemide.json';
    ...
    public function build(array $data): array
    {
        ...
        $variables = [
                ...
                'MedicationRequest_FurosemiDay1' => $data['MedicationRequest_FurosemiDay1']
        ];
