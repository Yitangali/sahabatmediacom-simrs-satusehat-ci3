...
class MedicationDispenseCreateFurosemide extends SatusehatPayload
{
    protected $CI;
    //protected $config;
    ...
    public function __construct()
    {
        ...
        $this->templatePath = APPPATH . 'libraries/Satusehat/Payloads/Medication/MedicationDispenseCreateFurosemide.json';
    ...
    public function build(array $data): array
    {
        ...
        $variables = [
                'Org_id' => $data['Org_id'],
                'Medication_ForDispense_FurosemideDay1' => $data['Medication_ForDispense_FurosemideDay1'],
