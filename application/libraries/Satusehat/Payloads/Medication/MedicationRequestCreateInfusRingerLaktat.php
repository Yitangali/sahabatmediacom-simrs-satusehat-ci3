...
class MedicationRequestCreateInfusRingerLaktat extends SatusehatPayload
{
    protected $CI;
    //protected $config;
    ...
    public function __construct()
    {
        ...
        $this->templatePath = APPPATH . 'libraries/Satusehat/Payloads/Medication/MedicationRequestCreateFurosemide.json';
    ...
    public function build(array $data): array
    {
        ...
        $variables = [
                'Org_id' => $data['Org_id'],
                'Medication_ForRequest_InfusDay1' => $data['Medication_ForRequest_FurosemideDay1'],
