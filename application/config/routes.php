...
$route['location_form'] = 'location_form/index';
$route['location_form/(:any)'] = 'location_form/$1';

// Practitioner Form Routes
$route['practitioner_form'] = 'practitioner_form/index';
$route['practitioner_form/(:any)'] = 'practitioner_form/$1';
